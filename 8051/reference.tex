...
\begin{center}
	\begin{tabular}{r|l c}
		...
		\hline
		External0 & \texttt{IE0} & \texttt{TCON.1} \\
		External1 & \texttt{IE1} & \texttt{TCON.3} \\
		Timer1 & \texttt{TF1} & \texttt{TCON.7} \\
		Timer0 & \texttt{TF0} & \texttt{TCON.5} \\
		Transmit & \texttt{TI} & \texttt{SCON.1} \\
		Receive & \texttt{RI} & \texttt{SCON.0} \\
	\end{tabular}
\end{center}
